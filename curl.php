...
class curl{
	...
	static function getContentSafely($URL,$post=null,$cookieFile=null,$options=array()){
	...
	static function push(){
		...
		if (!self::$master || \gettype(self::$master)=='unknown type')self::$master=\curl_multi_init();
		// $curl_arr=array();
